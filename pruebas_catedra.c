...
//     print_test("Prueba hash iter crear iterador hash vacio", true //iter);
//     print_test("Prueba hash iter esta al final", true// hash_iter_al_final(iter));
//     print_test("Prueba hash iter avanzar es false", true //!hash_iter_avanzar(iter));
//     print_test("Prueba hash iter ver actual es NULL", true //!hash_iter_ver_actual(iter));
